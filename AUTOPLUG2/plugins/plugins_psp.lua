...
{	name = "GE Patch Plugin v0.14", name = "ge_patch.prx", path = "seplugins/", txt = "game.txt", version = "0001", desc = LANGUAGE["GE_PATCH_DESC"], KEY = "GE_PATCH_DESC", link = "https://raw.githubusercontent.com/TheOfficialFloW/GePatch/master/README.md", },
