...
--LBP
FRENCH["NO_LBP_GAMES"] =                            "LittleBigPlanet non trouvé"
FRENCH["INSTALL_LBP_TITLE"] =                       "Serveur personnalisé de LittleBigPlanet"
FRENCH["LBP_ALLEFRESHER_DESC"] =                    "Un ensemble de plugins CFW pour la mise à jour des jeux LittleBigPlanet afin de permettre la connexion à des serveurs personnalisés."
FRENCH["LBP_ALLEFRESHER_ITLS"] =                    "Le plugin Allefresher nécessite l'installation d'iTLS"
FRENCH["INSTALL_LBP_360_365"] =                     "Allefresher ne fonctionne pas sous 3.67/3.68"
FRENCH["INSTALLING_LBP_PATCH"] =                    "Installation du patch Allefresher"
FRENCH["INSTALLING_LBP_VERSION"] =                  "LittleBigPlanet version 1.22 est requis"
FRENCH["INSTALLING_LBP_VERSION_PBP"] =              "LittleBigPlanet version 2.05 est requis"
...
FRENCH["LEDA_DESC"] =                               "LEDA est un plugin conçu pour assurer la compatibilité avec les logiciels hérités/homebrew qui utilisent le noyau 1.50."
...
FRENCH["INSTALLP_DESC_NOPSPEMUDRM_MOD"] =           "(A utiliser avec  ARK) Un plugin pour contourner toutes les vérifications DRM des jeux PSP officiel, afin que vous puissiez jouer aux jeux PSP ou PS1 en version numériques; ou bien sûr, a des jeux que vous possédez légitimement mais sur un autre compte PSN"
...
FRENCH["INSTALLP_DESC_USBMCMOD"] =                  "Stockage USB sous forme de carte mémoire Vita, Recommandé pour Psvsd v3.1 ou supérieur."
...
FRENCH["INSTALLP_DESC_PSVSHELL_MOD"] =              "(RaanGi) Encore un autre plugin d'overclock (SELECT + UP ou SELECT + DOWN pour basculer entre les 3 modes de l'interface graphique)"
