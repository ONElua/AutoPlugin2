...
FRENCH["MENU_EXTRAS_INSTALL_VITASHELL_DESC"] =      "Téléchargez et installez Vitashell directement sur votre PSVita"
FRENCH["MENU_EXTRAS_INSTALL_SHARKF00D_DESC"] =      "Téléchargez et installez ShaRKF00D directement sur votre PSVita"
...
--KERNEL
FRENCH["INSTALLP_DESC_KUBRIDGE"] =                  "Kernel-user bridge module for PS Vita (Needed for ported MaxPayne game)"
...
FRENCH["INSTALLP_DESC_DS34VITA"] =                  "Combines functionality of xerpi's ds4vita and ds3vita. Alows to use up to two controllers at the same time."
FRENCH["INSTALLP_DESC_REVITA"] =                    "reVita is a plugin for PS Vita / PS TV, which allows you to remap inputs and trigger different actions. It is a continuation of Rinnegatamante's remaPSV, which was fully rewritten as a kernel plugin. (To bring the config menu, press START + SQUARE, customisable under Settings -> Hotkeys.)"
FRENCH["INSTALLP_DESC_REVITA_GYRO"] =               "Add Gyro support ?"
...
FRENCH["INSTALLP_DESC_CAPUNLOCK"] =                 "Unlocks some non-game capabilities for PS Vita homebrew apps. Currently available: Allow mounting some virtual drives like cache0: and Allow using 4th core for game applications."
...
FRENCH["INSTALLP_DESC_FUCKPSSE"] =                  "A plugin to Dump & Decrypt PSSE-Protected Games."
