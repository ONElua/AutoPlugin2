...
SPANISH["MENU_EXTRAS_INSTALL_YAMT_DESC"] =              "Permite descargar e instalar Yamt en tu PS Vita: Yet another (re)mount tool kernel plugin for PS Vita/PS TV (Requires Enso, compatible ONLY with firmware 3.60 and 3.65)"
...
--KERNEL
SPANISH["INSTALLP_DESC_RESAVEDATA"] =                   "Plugin that redirects savedata such as games to ux0:resavedata without pfs encryption. (Redirected only if the directory with the title id exists in ux0:resavedata/ like ux0:resavedata/PCSG00001/)"
...
SPANISH["INSTALLP_DESC_REPATCHEX"] =                    "Modification of rePatch that adds Homebrew app0: and ux0:/data migration to other partitions, allowing you to play games with data on different storage."
...
SPANISH["INSTALLP_DESC_DS5VITA"] =                      "Plugin to use PS5 dualsense on PSVITA"
...
SPANISH["INSTALLP_DESC_CAPUNLOCK"] =                    "Unlocks some non-game capabilities for PS Vita homebrew apps. Currently available: Allow mounting some virtual drives like cache0: and Allow using 4th core for game applications."
