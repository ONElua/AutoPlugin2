...
PORTUGUESE_BR["MENU_PSVITA_GR"] =                          "Gravity Rush 544P"
PORTUGUESE_BR["NO_GRAVITYRUSH_GAMES"] =                    "Gravity Rush not found"
...
PORTUGUESE_BR["INSTALLING_LBP_VERSION_PBP"] =              "LittleBigPlanet version 2.05 is required"
...
PORTUGUESE_BR["SEARCH_PLUGIN_OSK_TITLE"] =                 "Search plugin by name"
PORTUGUESE_BR["SEARCH_PLUGIN_LABEL"]     =                 "Search plugin"
PORTUGUESE_BR["SEARCH_PLUGIN_HINT"]      =                 "L: Search   R: Clear"
...
PORTUGUESE_BR["MENU_EXTRAS_INSTALL_WAVERELOAD"] =          "psp2wpp-reload"

PORTUGUESE_BR["MENU_EXTRAS_INSTALL_WAVERELOAD_DESC"] =     "You can reload waveparam.txt while editing txt"
...
PORTUGUESE_BR["INSTALLP_WARNING_VITATV"] =                 "Plugin only work in Vita TV"
...
--QuickMenu Plus
PORTUGUESE_BR["QUICKMENU_MENU_BACKGROUND_GRAD"] =          "Background Gradient Effect"
PORTUGUESE_BR["QUICKMENU_MENU_BACKGROUNDGRAD_DESC"] =      "Sets the background gradient effect. The default is enabled."
...
--KERNEL
PORTUGUESE_BR["INSTALLP_DESC_VITAPRESENCE"] =              "Change your Discord rich presence to your currently playing PS Vita game!"
...
PORTUGUESE_BR["INSTALLP_DESC_NOPSPEMUDRM_MOD"] =           "(Special for ARK) A plugin to bypass all PSPEmu DRM Checks, so you can play digital PSP or PS1 game backups; or of course- games you legitimately own but on another PSN Account"
...
PORTUGUESE_BR["INSTALLP_DESC_PSVSHELL_MOD"] =              "(RaanGi) Yet another overclocking plugin (SELECT + UP or SELECT + DOWN to toggle between 3 GUI modes)"
...
PORTUGUESE_BR["INSTALLP_DESC_MOONSHINE"] =                 "Moonshine is a plugin that blocks PSN presence and status posts."
...
--Main
PORTUGUESE_BR["INSTALLP_DESC_NOTRPDRM"] =                  "NoTrpDrm is a plugin that enables official trophies pack usage with sceNpTrophy for homebrews on a PlayStation Vita system."
...
PORTUGUESE_BR["INSTALLP_DESC_QUICKMENUREBORN"] =           "Library for developers to easily add their own widgets, to the vita's Quick Menu."
PORTUGUESE_BR["INSTALLP_DESC_DOLCEWIFI"] =                 "Plugin to add an enable / disable toggle for WiFi in the quick menu on PSTV (dolce) systems. Made using QuickMenuReborn."
PORTUGUESE_BR["INSTALLP_DESC_WAVE"] =                      "A PS Vita home background wave add plugin."

--ALL
PORTUGUESE_BR["INSTALLP_DESC_ADRUSBENABLER"] =             "PSVita plugin to enable usb pairing between adrenaline and ps2/ps3"
...
--*NPUZ01234 *SCPS10084
PORTUGUESE_BR["INSTALLP_DESC_EF2UMA"] =                    "Enabling PSP Go's ef0 (Internal Memory) and redirecting it to PS Vita's uma0:pspemu/, while leaving the original mapping of ms0 to ux0:pspemu/ intact, allowing both devices to be accessed at the same time."
PORTUGUESE_BR["INSTALLP_DESC_EF2XMC"] =                    "Enabling PSP Go's ef0 (Internal Memory) and redirecting it to PS Vita's xmc0:pspemu/, while leaving the original mapping of ms0 to ux0:pspemu/ intact, allowing both devices to be accessed at the same time."
...
PORTUGUESE_BR["INSTALLP_DESC_GR544P"] =                    "A TAIHEN plugin for enabling a feature complete 544p resolution upgrade for Gravity Rush on the PS VITA."
