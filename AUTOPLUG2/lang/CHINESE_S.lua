...
CHINESE_S["INSTALLP_DESC_UDCDUVCO"] =                  "(仅限 OLED) 在屏幕关闭的情况下使用 USB 线缆将 Vita 屏显内容流式传输到电脑, 官方版本做不到这一点"
CHINESE_S["INSTALLP_DESC_UDCDUVCL"] =                  "(仅限 LCD) 在屏幕关闭的情况下使用 USB 线缆将 Vita 屏显内容流式传输到电脑, 官方版本做不到这一点"
