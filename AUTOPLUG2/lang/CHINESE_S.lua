...
CHINESE_S["INSTALLP_REVITA_360_365"] =                 "reVita only work on 3.60/3.65"
...
CHINESE_S["INSTALLP_DESC_DS34VITA"] =                  "Combines functionality of xerpi's ds4vita and ds3vita. Alows to use up to two controllers at the same time."
CHINESE_S["INSTALLP_DESC_REVITA"] =                    "reVita is a plugin for PS Vita / PS TV, which allows you to remap inputs and trigger different actions. It is a continuation of Rinnegatamante's remaPSV, which was fully rewritten as a kernel plugin. (To bring the config menu, press START + SQUARE, customisable under Settings -> Hotkeys.)"
CHINESE_S["INSTALLP_DESC_REVITA_GYRO"] =               "Add Gyro support ?"
...
CHINESE_S["INSTALLP_DESC_CAPUNLOCK"] =                 "Unlocks some non-game capabilities for PS Vita homebrew apps. Currently available: Allow mounting some virtual drives like cache0: and Allow using 4th core for game applications."
