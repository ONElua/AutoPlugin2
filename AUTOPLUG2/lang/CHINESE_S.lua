...
CHINESE_S["UPDATER_PERCENT"] =                         "百分比: "
CHINESE_S["UPDATER_SEARCH_UNSAFE_VPK"] =               "正在扫描 vpk, 排查不安全或危险文件!"
...
CHINESE_S["MENU_PSVITA_UNINSTALL_PLUGINS_DESC"] =      "轻松简单地卸载插件"
...
CHINESE_S["MENU_PSVITA_CHECK_ONLINE_PLUGINS_DESC"] =   "检查是否有插件更新"
...
CHINESE_S["MENU_EXTRAS_CUSTOMWARNING_DESC"] =          "当使用 ENSO 系统开机时,允许你设置自定义警告消息替代癫痫警告"
...
--StorageMgr
CHINESE_S["INSTALLP_DESC_SD2VITA"] =                   "自动将任何存储设备挂载/重定向到任何所需的挂载点的内核插件 (适用于SD2VITA)"

--KERNEL
CHINESE_S["INSTALLP_DESC_NONPDRM"] =                   "允许您绕过任何 PSVita 内容的 DRM 保护机制"
CHINESE_S["INSTALLP_DESC_NONPDRMU"] =                  "允许您绕过任何 PSVita 内容的 DRM 保护机制(第三方 MOD)"
...
CHINESE_S["INSTALLP_DESC_LOLICON"] =                   "通过从内核运行的小型 Vita shell 实现实际超频至 500 MHz (SELECT + UP 启动菜单. SELECT + DOWN 关闭菜单)"
CHINESE_S["INSTALLP_DESC_DS3VITA"] =                   "使用 DualShock 3 控制PSV"
CHINESE_S["INSTALLP_DESC_DS4VITA"] =                   "使用 DualShock 4 控制PSV"
CHINESE_S["INSTALLP_DESC_UDCDUVC"] =                   "使您可以使用 USB 线缆将 Vita 屏显内容流式传输到电脑 (官方版本)"
CHINESE_S["INSTALLP_DESC_UDCDUVCO"] =                  "(仅限 OLED) 使您可以在屏幕关闭的情况下使用 USB 线缆将 Vita 屏显内容流式传输到电脑, 官方版本做不到这一点"
CHINESE_S["INSTALLP_DESC_UDCDUVCL"] =                  "(仅限 LCD) 使您可以在屏幕关闭的情况下使用 USB 线缆将 Vita 屏显内容流式传输到电脑, 官方版本做不到这一点"
...
CHINESE_S["INSTALLP_DESC_NOSHAREDFB"] =                "允许在系统模式下运行但使用标准帧缓冲实现的自制应用程序,在挂起恢复周期之后绕过共享的帧缓冲问题的插件."
