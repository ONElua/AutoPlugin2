...
CHINESE_S["MENU_DOWNLOADS"] =                          "Downloads"
...
CHINESE_S["MENU_EXTRAS_INSTALL_YAMT"] =                "Download and install Yamt vpk"
...
CHINESE_S["MENU_EXTRAS_INSTALL_YAMT_DESC"] =           "Download and install Yamt vpk in your Vita: Yet another (re)mount tool kernel plugin for PS Vita/PS TV (Requires Enso, compatible ONLY with firmware 3.60 and 3.65)"
...
CHINESE_S["INSTALLP_DESC_REPATCHEX"] =                 "Modification of rePatch that adds Homebrew app0: and ux0:/data migration to other partitions, allowing you to play games with data on different storage."
...
CHINESE_S["INSTALLP_DESC_FUCKPSSE"] =                  "A plugin to Dump & Decrypt PSSE-Protected Games."
