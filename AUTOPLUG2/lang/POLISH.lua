...
POLISH["INSTALLING_LBP_VERSION_PBP"] =              "LittleBigPlanet version 2.05 is required"
...
POLISH["LEDA_DESC"] =                               "LEDA is a plugin designed to provide compatibility with legacy software/homebrew that uses 1.50 kernel."
