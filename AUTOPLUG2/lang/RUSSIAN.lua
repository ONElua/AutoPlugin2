...
RUSSIAN["INSTALLP_DESC_ADRENALINE"] =                "Позволяет пропустить первый холостой запуск Adrenaline после включения системы. Note: Adrenaline´s latest version must be installed"
