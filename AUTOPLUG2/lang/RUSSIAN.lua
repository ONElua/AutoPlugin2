...
RUSSIAN["MENU_DOWNLOADS"] =                          "Downloads"
...
RUSSIAN["MENU_EXTRAS_INSTALL_YAMT"] =                "Download and install Yamt vpk"
...
RUSSIAN["MENU_EXTRAS_INSTALL_YAMT_DESC"] =           "Download and install Yamt vpk in your Vita: Yet another (re)mount tool kernel plugin for PS Vita/PS TV (Requires Enso, compatible ONLY with firmware 3.60 and 3.65)"
...
--KERNEL
RUSSIAN["INSTALLP_DESC_RESAVEDATA"] =                "Plugin that redirects savedata such as games to ux0:resavedata without pfs encryption. (Redirected only if the directory with the title id exists in ux0:resavedata/ like ux0:resavedata/PCSG00001/)"
